...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pinnedWish = `
        <div class="wish-card wish-card-pinned">
            <div class="wish-pinned-header">
                <span>📌</span><strong>Eren Kesimal</strong>
            </div>
            <p>Birlikte çıkacağınız bu güzel hayat yolculuğunda her gününüz sevgi, huzur ve mutlulukla dolsun. Canım abim ve yengem, ömür boyu el ele olmanız dileğiyle...</p>
        </div>
    `;
    ...
    function renderWishes() {
        ...
        wishesWall.innerHTML = pinnedWish + otherWishes;
    }
    renderWishes();
